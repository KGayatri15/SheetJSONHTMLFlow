...
class ActionEngine {
   ...
   * @param {unknown} [resultObj=[]] - Optional parameter for passing result of previous requests
   * @returns {Promise}
   */
  //changes
  //1.Made result object as an array.A flow Request can need any result of previous flow requests rather than before one.
  //1.1 Included handleArguments method to simplify assigning arguments to a process Eg arguments:['fromPrevious[1]',1]//Result of FlowRequest index 1
